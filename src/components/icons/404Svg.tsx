export const Error404Svg = () => {
   return (
      <svg
         ...
         <circle cx="115.32" cy="60.66" r="19.14" fill="#ffd200" className="fill-warning"></circle>
         <circle cx="115.32" cy="60.66" r="36.49" fill="#ffd200" className="fill-warning" opacity="0.15"></circle>
